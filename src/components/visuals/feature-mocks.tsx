  ...
  return (
    <Frame title="POST /v1/workflows/run">
      <pre className="text-[11px] leading-relaxed font-mono whitespace-pre">
        <span className="text-muted-foreground">curl</span> https://api.hypero.dev/v1/workflows/run{`\n`}
        <span className="text-muted-foreground">  -H</span> &quot;Authorization: Bearer $HYP&quot;{`\n`}
